    ...
    <div class="modal-dialog modal-dialog-centered">
        <form action="/citas/guardar" method="POST" class="modal-content p-3">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label>Estado</label>
                    <input type="text" name="estadoCita" class="form-control" required>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form action="/citas/editar" method="POST" class="modal-content p-3">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label>Hora</label>
                    <input type="time" name="horaCita" id="edit_horaCita" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label>Estado</label>
                    <input type="text" name="estadoCita" id="edit_estadoCita" class="form-control" required>
                </div>
            </div>
            <div class="modal-footer">
